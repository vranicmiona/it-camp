...
const r = +prpompt("Unesite rastojanje ograde od terena: ");
...
if (isNaN(d) || isNaN(s) || isNaN(r)) {
    ...
    if (isNaN(x) || isNaN(y)) {
        ...
        if(isNaN(broj1) || isNaN(broj2)) {
            ...
            }console.log("Aritmeticka sredina broja " + broj2ZaIspis + " do broja" + broj1 + " iznosi" + suma / brojac + ".");
        }
...
} console.log("Ukupno ima brojeva, " + coun + " koji su deljivi sa 5 " + " njihov zbir\n iznosi " + zbir + ".");
...
}console.log("Aritmentick sredina brojeva, kojih ima " + brojanje + "i njihov zbir je jednak " + sabiraka + ",sve to zajedno nam daje resenje " + sabiraka / brojanje + ".");