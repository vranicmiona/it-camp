...
const recenica2 = "Danas su pocela cetvrtfinala svetskog prvnstva u fudbalu, takodje je danas bila dodela sertifikata.";
...
// 2. Template literals dozvoljavaju multilne stringove
...
let a = 5;
let b = 34;
const recenica4 = `Jedna flasa ima zapreminu ${a}l, ukupna kolicina limunade je ${b}l. Stoga mozemo napuniti ${Math.floor(b/a)} flasa limunade.`;
...
function mojaFunkcija(recenica5){
    if(recenica5.includes("skola")){
        ...
        let brojac = 0;if(recenica5.includes("kuca")) {
...
}; console.log(mojaFunkcija("skola je uticala da Alen i Hatidza spavaju za vreme casa."));
