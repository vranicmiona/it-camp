...
const brojevi =
  "Danas je utorak 11/08/2022, to bi znacilo da idemo u skolu vec 39 dana.";
...
const treciZadatak =
  "Danas je sreda i bas je lep i suncan dan. Ja sam Miona Vranic!";
let n = 0;
...
const cetvrtiZadatak =
  "Od casova danas na PMF sam imala, Fizicku hemiju i  Organsku hemiju.";
let mala = 0;
let velika = 0;
